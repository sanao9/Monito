  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between bg-beige rounded-xl p-8 md:p-16">
      ...
      <div className="max-w-lg">
        ...
        <p className="text-xl md:text-2xl font-semibold text-darkBlue mb-6">
        ...
        <div className="flex space-x-4">
          <button className="bg-darkBlue text-white px-6 py-3 rounded-full hover:bg-blue-950">
            Explore Now
          </button>
          <button className="flex items-center px-6 py-3 border-2 border-darkBlue text-darkBlue rounded-full hover:bg-blue-950 hover:text-white transition">
            View Intro
