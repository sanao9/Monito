    ...
    <div className="flex  items-center justify-between  bg-[linear-gradient(102.87deg,#FCEED5_6.43%,#FCEED5_78.33%,#FFE7BA_104.24%)] w-full 2xl:h-[700px] xl:h-[600px] lg:h-[550px] overflow-hidden ">
      ...
      <div className="container mx-auto z-10">
        ...
        <div className="flex ml-36 space-x-4">
          <button className="flex items-center px-6 py-2 border-2 border-blue-900 rounded-full text-blue-900 hover:bg-blue-900 hover:text-white transition">
            View Intro
            <svg
          ...
          <button className="px-6 py-2 bg-blue-900 text-white rounded-full hover:bg-blue-800 transition">
            Explore Now
          </button>
        </div>
